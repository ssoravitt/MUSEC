...
def svm(kfold):
    ...
    def _classification():
        ...
        #         print("TRAIN:", train_index, "TEST:", test_index)
                ...
                gridsearch = GridSearchCV(SVC(class_weight='balanced'),
                                          parameters,
                                          cv=k_fold,
                                          verbose=1,
                                          n_jobs=6)
                ...
                svc = SVC(**optimal_params, class_weight='balanced') # class_weight = 'balanced' = {Favored :3 and Non_favored :1) approximately.
...
#                 print ("---------------------------------------------------------")
                # print (f1_[1])
                kfold_accuracy_list.append(svc_accuracy) # 10 models
...
if __name__ == '__main__':
  ...
  svm_stratified.to_csv('svm_result_frontal_fam_2.csv')
  print ('Done')
