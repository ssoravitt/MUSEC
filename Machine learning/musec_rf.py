...
path_csv = os.getcwd() + '/dataframe/df_hemisphere_svm.csv'
...
def df_for_ml():
    audio_hemisphere = ['Melody | Left', 'Melody | Right', 'Song | Left', 'Song | Right']
...
def svm(kfold):
    ...
    def _classification():
        ...
        #         print("TRAIN:", train_index, "TEST:", test_index)
                ...
                rf = RandomForestClassifier(**optimal_params, random_state=42) # class_weight = 'balanced' = {Favored :3 and Non_favored :1) approximately.
                print (rf.get_params())
...
#                 print ("---------------------------------------------------------")
                # print (f1_[1])
                kfold_accuracy_list.append(rf_accuracy) # 10 models
...
if __name__ == '__main__':
  svm_stratified = svm(kfold='Stratified')
  #svm_loso = svm(kfold='LeaveOneSubjectOut')
  #result_df = svm_stratified.merge(right=svm_loso, left_index=True, right_index=True)
  #result_df.to_csv('svm_result_dividing_behaviour.csv')
  svm_stratified.to_csv('rf_result_hemisphere_behaviors.csv')
  print ('Done')
